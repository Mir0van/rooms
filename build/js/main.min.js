...
},{"../../utils/mobile-checker":5}],3:[function(require,module,exports){
"use strict";
...
var _setHeight = require("./set-height");
...
var initReservation = exports.initReservation = function initReservation() {
  ...
  rooms.forEach(function (room) {
    ...
    (0, _setHeight.setBlokHeight)(room);
  });
};

},{"../../utils/mobile-checker":5,"./mobile-styles-toggle":2,"./set-height":4}],4:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.setBlokHeight = void 0;
var padding = {
  desktop: 23,
  tablet: 25,
  mobile: 22
...
var setMinHeight = function setMinHeight(element, indent) {
  var infoElement = element.querySelector('.room__info-wrapper');
  var parentInfoElement = infoElement.parentNode;
  infoElement.style.minHeight = "".concat(parentInfoElement.offsetHeight + indent, "px");
};
var initMinHeight = function initMinHeight(element) {
...
var setMaxHeight = function setMaxHeight(element) {
  var infoElement = element.querySelector('.room__info-wrapper');
  infoElement.style.maxHeight = "".concat(element.offsetHeight, "px");
};
var setBlokHeight = exports.setBlokHeight = function setBlokHeight(element) {
